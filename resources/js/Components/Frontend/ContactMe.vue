...
<template>
  <section id="contact" class="section bg-light-primary dark:bg-dark-primary mt-24">
    <div
    ...
    >
      <div class="flex flex-col items-center text-center">
        <h2 class="text-3xl lg:text-4xl text-white font-medium lg:font-extrabold mt-24 mb-3">Contact Me</h2>
        <p class="subtitle">
          Contact me via the website or via email
        </p>
      </div>
      <div class="flex flex-col lg:flex-row lg:gap-x-8 mt-24">
        <div
          class="
        ...
        >
          <div class="flex flex-col lg:flex-row gap-x-4">
            ...
            <div>
              ...
              <p class="text-accent font-normal">Email me at midohussain70@gmail.com</p>
            </div>
          </div>
          <div class="flex flex-col lg:flex-row gap-x-4">
            <div
        ...
        <form @submit.prevent="submit" class="space-y-8 w-full max-w-md">
          ...
          <button class="btn-s btn btn-lg bg-accent hover:bg-secondary text-white">
            Send message
          </button>
        </form>
      </div>
